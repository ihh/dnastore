...
\newcommand\inseqnext{\inseq_q}

\newcommand\nucalph{\somealph_{\mbox{\tiny DNA}}}
\newcommand\sym{x}
\newcommand\sympast{w}
\newcommand\symnext{\sym}
...
\newcommand\contextlen{C}
\newcommand\conseq[2]{\sym_{#1} \ldots \sym_{#2}}
\newcommand\conseqpast[2]{\sympast_{#1} \ldots \sympast_{#2}}
\newcommand\conseqnext[2]{\symnext_{#1} \ldots \symnext_{#2}}
\newcommand\outsym{y}
...
\newcommand\psub[1]{\submat(\sym_{#1},\outsym)}
