...
\symstate{\srcblock}(\inseqpast,\sym \inseqnext) & \sym & \emptystring & \pdelopen & \symstate{f}(\emptystring,\emptystring) & \text{if $\destblock = f$} \\
\delstate{\srcblock}(\inseqpast,\sym \inseqnext) & \sym & \emptystring & \pdelext & \delstate{\destblock}(\inseqpast',\inseqnext') & \text{if $\srcblock \neq b$} \\
\delstate{\srcblock}(\inseqpast,\sym \inseqnext) & \emptystring & \emptystring & \pdelend & \symstate{\srcblock}(\inseqpast',\inseqnext') & \text{if $\srcblock \neq b$} \\
\hline
\end{array}
\]
