...
Useful to represent everything as state machines,
can then add a statistically-parameterized model of errors
in DNA sequencing and replication,
and use Viterbi algorithm for decoding

Transducers are a good technology \cite{MohriPereiraRiley2000,WikipediaTransducers}
In bioinformatics:
...
To do this at the Shannon limit requires an arithmetic conversion of the binary number into the decimal number
...
Converting this to a mixed-radix sequence of bits, trits and quats
