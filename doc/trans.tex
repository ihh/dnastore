...
MacKay et al developed error-correcting codes that are resistant to
substitutions, insertions and deletions, including watermark codes \cite{DaveyMackay2000,DaveyMackay2001}
...
Error-correcting codes (for example, Hamming codes that introduce parity bits, or codes that maintain synchronization in the presence of insertions and deletions)
