...
% No - we don't need future context for invreps or duplications. Do everything with past context.
% Oh, actually... maybe we do. So we can have inverted duplications in both directions: right (ACG.->ACG.CGT) and left (.ACG->CGT.ACG)
