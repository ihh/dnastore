...
It would be straightforward to give the substitution matrix a richer parameterization
and to have it depend on the surrounding context,
which would make the error model more realistic.
To keep our implementation simple we used a simplified error model.
