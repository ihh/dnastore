...
\newpage
\begin{figure}
\includedot{hamming31}{width=.5\textwidth}
...
\newpage
\begin{figure}
\includedot{binary2quaternary}{width=.3\textwidth}
\includedot{quaternary2dna}{width=.3\textwidth}
\includedot{binary2dna}{width=.3\textwidth}
\caption{
...
\includedot{trinaryid}{width=.25\textwidth}
\includedot{binaryeraser}{width=.25\textwidth}
\includedot{trinaryonly}{width=.45\textwidth}
...
\newpage
\begin{figure}
\includedot{converter}{width=.5\textwidth}
\includedot{flush8}{width=.5\textwidth}
\caption{
\figlabel{Converter}
Left:
...
\newpage
\begin{figure}
\includedot{dna1rep}{width=.2\textwidth}
\includedot{dna2rep}{width=.4\textwidth}
\includedot{dna2repnoend}{width=.4\textwidth}
\includedot{dna2noend}{width=.4\textwidth}
\includedot{dna2}{width=.4\textwidth}
\caption{
  \figlabel{DNAStore}
