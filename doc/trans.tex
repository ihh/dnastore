...
to show both input and output labels
(the transition weights for the transducers shown pictorially in this paper are all equal to 1,
and are omitted from the visual representation).
\figref{HammingTransducer} shows a transducer that implements the Hamming(4,7) code,
while
\figref{BinaryToTrinary} shows a transducer that converts binary to trinary.
