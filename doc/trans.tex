...
The results of these computational experiments are summarized in \figref{DupPlot}, \figref{SubPlot}, \figref{DelPlot} and \figref{WatPlot}.
% WRITE ME
...
Levenshtein edit distance
...
Discretized ``edits per bit'' arise because the 8192-bit message is split into 8 1024-bit blocks for LDPC.
The LDPC decoder discards incomplete blocks, and the edit distance is consequently rounded to (close to) the nearest multiple of 1024
}
