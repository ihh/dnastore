...
% Block length & P(EOF) & States & Transitions & Input bits/output symbol in radix 2 & 3 & 4

\begin{table}
\begin{tabular}{rrrrrrr}
& & & & \multicolumn{3}{r}{Mean input bits/output symbol} \\
...
% Word length & Reserved words & States & Transitions & Input bits/output nucleotide
