...
\end{itemize}
These states have the following significance (see \figref{PartialObservation}a-b):
\begin{itemize}
...
By composing it with the transducer in \figref{PartialObservation}c, we can model errors and partial observation.
...
\caption{
  ...
  Top: Transducer $\transpartial$ models partial observation of a sequence.
