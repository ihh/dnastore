...
Levenshtein edit distance
...
Discretized ``edits per bit'' arise because the 8192-bit message is split into eight 1024-bit blocks for LDPC.
...
so---once the decoder starts missing whole blocks---the
dit distance per bit tends to be rounded up to the next multiple of 1/8.
}
