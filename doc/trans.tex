...
To convert a binary sequence into a mixed-radix sequence
...
\easyfig{eof2.ps}{width=\textwidth}{Arithmetic}{
  A transducer built using the method of \secref{Arithmetic}
  ...
  This code was designed with the probability of an end-of-file symbol set to 1/10.
}
