...
To prevent such problems, DNASTORE can accept arbitrary machine specifications in a JSON format
...
\tabref{DNASTORE.codes} shows statistics for codes generated with MIXRADAR.
