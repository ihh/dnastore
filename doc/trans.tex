...
Here we present a modular strategy for designing codes that meet such flexible needs
...
\item For every $k:1 \leq k < \contextlen$, every $k$-mer $\seqpast \in \outalph^k$ and every $\contextlen$-mer $\seqnext \in \outalph^\contextlen$
  there are two states $\{ \symstate{c}(\seqpast,\seqnext), \delstate{c}(\seqpast,\seqnext) \}$,
  $\contextlen$ states $\{ \revstate{i}{c}(\seqpast,\seqnext,i): 1 \leq i \leq \contextlen \}$ and
  $2k$ states $\{ \tanstate{c}{i}(\seqpast,\seqnext), \fwdstate{c}{i}(\seqpast,\seqnext): 1 \leq i \leq k \}$
  %
\item For every pair of $\contextlen$-mers $\seqpast, \seqnext \in \outalph^\contextlen$
  there are two states $\{ \symstate{d}(\seqpast,\seqnext), \delstate{d}(\seqpast,\seqnext) \}$ and
  $3\contextlen$ states $\{ \tanstate{d}{i}(\seqpast,\seqnext), \fwdstate{d}{i}(\seqpast,\seqnext), \revstate{d}{i}(\seqpast,\seqnext): 1 \leq i \leq \contextlen \}$
  %
\item For every $k:1 \leq k < \contextlen$, every $\contextlen$-mer $\seqpast \in \outalph^\contextlen$ and every $k$-mer $\seqnext \in \outalph^k$
  there are two states $\{ \symstate{e}(\seqpast,\seqnext), \delstate{d}(\seqpast,\seqnext) \}$,
  $2\contextlen$ states $\{ \tanstate{e}{i}(\seqpast,\seqnext), \fwdstate{e}{i}(\seqpast,\seqnext): 1 \leq i \leq \contextlen \}$ and 
  $k$ states $\{ \revstate{e}{i}(\seqpast,\seqnext): 1 \leq i \leq k \}$ 
  %
