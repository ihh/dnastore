...
with several different code formats (\figref{WatPlot}).
% WRITE ME
...
This allows for straightforward incorporation and refinement of specialized automata for
...
modeling errors, or other tasks as yet unnoted.
